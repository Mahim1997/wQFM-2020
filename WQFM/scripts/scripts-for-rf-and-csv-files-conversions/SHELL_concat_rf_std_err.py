...
def compute_avg_stats(name_to_write, file_input, csv_file):
    ...
    std_err = std_err['Std-Err'].values
    ...
    avg_rf_name = "rf-" + str(name_to_write)
    df_read[avg_rf_name] = mean

    std_err_name = "stderr-" + str(name_to_write)
    df_read[std_err_name] = std_err
