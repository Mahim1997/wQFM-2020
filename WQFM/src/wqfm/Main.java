...
//        TestNormalFunctions.testRerootJarFunctions(10000); //arg: how many times to check in  loop
//        TestNormalFunctions.testPerlReroot(1); // fails [for some reason ... don't explore further]
